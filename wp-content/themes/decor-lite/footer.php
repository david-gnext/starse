         ...
         <div class="copyright-wrapper">
        	<div class="container">
           		 <div class="copyright-txt">
								 <!-- <?php printf('<a target="_blank" href="'.esc_url(DECOR_LITE_SKTTHEMES_FREE_THEME_URL).'" rel="nofollow">Decor Lite</a>' ); ?> -->
								 © Copyright <?php echo date('Y'); ?> All Rights Reserved By STAR SE
							 </div>
                 <div class="clear"></div>
            </div>
        </div>
